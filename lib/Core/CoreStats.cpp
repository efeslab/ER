...
Statistic stats::executeMemopOOBCheck("internal_MemOOBCheck", "memopOOBC");
Statistic stats::executeMemopTimeInBounds("internal_MemopInBounds", "memopTimeInBounds");
Statistic stats::executeMemopTimeErrHandl("internal_MemopErrHandl", "memopTimeErrHandl");
// ** llvm ir instruction
...
Statistic stats::dummy3("************************   internal stats  *************************", "dummy3");
Statistic stats::switch_prepare("switch_prepare", "sprepare");
Statistic stats::switch_concrete("concrete_switch", "cswitch");
Statistic stats::switch_symbolic("symbolic_switch", "cswitch");
Statistic stats::dummy4("******************************** hase end *************************", "dummy4");
